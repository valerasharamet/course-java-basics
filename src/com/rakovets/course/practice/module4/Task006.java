...
public class Task006 {
	public static void main(String[] args) {
		...
		double costPerItem = startPriceAllItems / startNumberItems;
		String result = "";
		double totalSell = 0;
		for (int i = 0; i < sizeTotalPrice; i++) {
			result += (startNumberItems + i * differentialNumberItems) + " - " + ((startPriceAllItems + i * differentialNumberItems * costPerItem) * (1 - i * differentialSell / 100)) + " with sell " + (i * differentialSell) + "%" + (i!=sizeTotalPrice - 1 ? "\n":"");
		}
